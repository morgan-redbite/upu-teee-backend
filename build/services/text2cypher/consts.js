...
exports.MAX_NUM_VALIDATION = exports.reportExampleQueries = exports.reportTypesToDesc = exports.SCHEMA_SAMPLING_NUMBER = exports.schemaSamplingQuery = exports.QUERY_TRANSLATOR_TASK = exports.relQuery = exports.relPropsQuery = exports.nodePropsQuery = void 0;
exports.nodePropsQuery = `CALL apoc.meta.data()
YIELD label, other, elementType, type, property
WHERE NOT type = "RELATIONSHIP" AND elementType = "node"
WITH label AS nodeLabels, collect(property) AS properties
RETURN {labels: nodeLabels, properties: properties} AS output
`;
exports.relPropsQuery = `
CALL apoc.meta.data()
YIELD label, other, elementType, type, property
...
`;
exports.SCHEMA_SAMPLING_NUMBER = 10000;
exports.reportTypesToDesc = {
    table: 'Multiple variables representing property values of nodes and relationships.',
    graph: 'Multiple variables representing nodes objects and relationships objects inside the graph. Please return also the relationship objects.',
